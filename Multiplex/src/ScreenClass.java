...
public class ScreenClass extends JFrame implements ActionListener,ListSelectionListener,ItemListener
{
    Connection con;
    ResultSet rs;
    ...
    public ScreenClass() 
    {
        ...
        cf = new Choice();
	cf.addItem("ScreenClassId");
	cf.addItem("ClassName");
    ...
    private void initComponents() {
        ...
        tempclassid = new javax.swing.JTextField();
        tempcname = new javax.swing.JTextField();
        ...
        jLabel1.setText("SCREEN CLASS DETAILS");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel2.setText("Screen Class Id");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(20, 20, 20)
                                .addComponent(Bhome, javax.swing.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(tempclassid, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(tempcname, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
                                            .addComponent(temprate, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(tempscreenid))
                                        .addComponent(tempid, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(tempclassid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(17, 17, 17)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(tempcname, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(22, 22, 22)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
public void createTableGrid()
{
      //To Cerate Table Grid ---------------------------
		...
		dtm.addColumn("ScreenClassId");
		dtm.addColumn("ScreenClassName");
		dtm.addColumn("Rate");
    ...
    try
        {
				...
				rs = st.executeQuery("Select * From ScreenClass");
                                rs.first();
                                tempclassid.setText(rs.getString("ScreenClassId"));
				tempcname.setText(rs.getString("ClassName"));
				...
				while(rs.next())
				{
                                        ...
                                        found = true;
					String CId = rs.getString("ScreenClassId");
					String CName = rs.getString("ClassName");
					String CRate = rs.getString("Rate");
                                        String ScreenId = rs.getString("ScreenId");
					String EmpId = rs.getString("EmpId");
					String SModiDate = rs.getString("ModificationDate");
					
					String row[] = new String[]{CId, CName, CRate, ScreenId,EmpId,SModiDate};
    ...
    try
                {
                    ...
                    String id = tempclassid.getText();
                    String query = "Delete From ScreenClass where ScreenClassId=" +id;
...
public void insertRecord()
{
  EditSetting();
   insertFlag = true;
                                ...
                                {
                                     rs.last();
                                     int id = Integer.parseInt(rs.getString("ScreenClassId"));
                                     id = id+1;
                                     JOptionPane.showMessageDialog(this,id);
                                     
                                     //Convert Int to String
                                     tempclassid.setText(Integer.toString(id));
    ...
    if(insertFlag==true)
     {
        ...
        String CId = tempclassid.getText();
	String CName = tempcname.getText();
	String CRate = temprate.getText();
	String ScreenId = tempscreenid.getText(); 
	...
	try
		{
                    //QueryString = "INSERT INTO user_master1(User_Name,UserId,User_Pwd) VALUES ('Mahendra',"+ "'mahendra25','1213456')"; 
                        ...
                        String query = "insert into ScreenClass(ClassName,Rate,ScreenId,EmpId,ModificationDate) values('"+CName+"','"+CRate+"','"+ScreenId+"','"+EmpId+"',"+SModiDate+")";
       ...
       if(insertFlag==false)       
              {
                  try
		  {
    			        ps=con.prepareStatement("update ScreenClass set ClassName=?,Rate=?,ScreenId=?,EmpId=?, ModificationDate=? where ScreenClassId =?");
				
				ps.setString(1,tempcname.getText());
				ps.setString(2,temprate.getText());
				ps.setString(3,tempscreenid.getText());
                                 ps.setString(4,tempid.getText());
				ps.setString(5,tempdate.getText());
                                ps.setString(6,tempclassid.getText());
...
public void searchRecord()
{
   ...
   try
   {
	ps = con.prepareStatement("select * from ScreenClass where "+field+"=?");
	if(field.equals("ClassName"))
	{
	   ps.setString(1,value);
	}
	else
	if(field.equals("ScreenClassId"))
	{
...
public void cancleRecord()
{
     ...
     bindTable();
             ...
             try
             {
                ...
                tempclassid.setText(rs.getString("ScreenId"));
                tempcname.setText(rs.getString("ScreenName"));
                temprate.setText(rs.getString("Capacity"));
                tempscreenid.setText(rs.getString("ScreenId"));
                tempid.setText(rs.getString("EmpId"));
                tempdate.setText(rs.getString("ModificationDate"));
 ...
 public void valueChanged(ListSelectionEvent le)
{
		if(le.getSource() == lsm)
		{
			...
			String cid = (String)t.getValueAt(gsr,0);
			String cname = (String)t.getValueAt(gsr,1);
			String rate = (String)t.getValueAt(gsr,2);
			String screenid = (String)t.getValueAt(gsr,3);
                        String empid = (String)t.getValueAt(gsr,4);
			String modidate = (String)t.getValueAt(gsr,5);
                      
                        //--------------------
			tempclassid.setText(cid);
			tempcname.setText(cname);
			temprate.setText(rate);
			tempscreenid.setText(screenid);
...
{
                tempclassid.setEditable(false);
                tempcname.setEditable(true);
                temprate.setEditable(true);
                tempscreenid.setEditable(true);
...
public static void main(String args[]) 
{
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScreenClass().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField tempclassid;
    private javax.swing.JTextField tempcname;
