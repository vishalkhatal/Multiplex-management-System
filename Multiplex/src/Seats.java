...
public class Seats extends JFrame implements ActionListener,ListSelectionListener,ItemListener
{
    Connection con;
    ResultSet rs;
    ...
    private void initComponents() {
        ...
        tempseatid = new javax.swing.JTextField();
        tempseatno = new javax.swing.JTextField();
        ...
        jLabel7.setText("Screen Class Id");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12));
        jLabel8.setText("Seat No");

        tempseatid.setEditable(false);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(20, 20, 20)
                        .addComponent(Bhome, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGap(13, 13, 13)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(tempseatid, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(tempseatno, javax.swing.GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
                                .addComponent(tempclassid, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(tempid)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(tempseatid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(17, 17, 17)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
                    .addComponent(tempseatno, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(22, 22, 22)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
public void createTableGrid()
{
      //To Cerate Table Grid ---------------------------
		...
		dtm.addColumn("SeatId");
		dtm.addColumn("SeatNo");
		dtm.addColumn("SeatClassId");
		dtm.addColumn("EmpId");
    ...
    try
        {
				...
				rs = st.executeQuery("Select * From Seats");
                                rs.first();
                                tempseatid.setText(rs.getString("SeatId"));
				tempseatno.setText(rs.getString("SeatNo"));
				...
				while(rs.next())
				{
					...
					String SName = rs.getString("SeatNo");
					String SClassId = rs.getString("ScreenClassId");
					String EmpId = rs.getString("EmpId");
					String SModiDate = rs.getString("ModificationDate");
					
					String row[] = new String[]{SId, SName, SClassId, EmpId,SModiDate};
...
public void insertRecord()
{
  EditSetting();
   insertFlag = true;
                                ...
                                {
                                     rs.last();
                                     int id = Integer.parseInt(rs.getString("SeatId"));
                                     id = id+1;
                                     JOptionPane.showMessageDialog(this,id);
                                     
                                     //Convert Int to String
                                     tempseatid.setText(Integer.toString(id));
...
public void saveRecord()
{
    ...
    if(insertFlag==true)
     {
        String SId = tempseatid.getText();
	String SName =tempseatno.getText();
	String SClassId = tempclassid.getText();
	...
	try
		{
                    //QueryString = "INSERT INTO user_master1(User_Name,UserId,User_Pwd) VALUES ('Mahendra',"+ "'mahendra25','1213456')"; 
                        ...
                        String query = "insert into Seats(SeatNo,ScreenId,EmpId,ModificationDate) values('"+SName+"','"+SClassId+"','"+EmpId+"',"+SModiDate+")";
       ...
       if(insertFlag==false)       
              {
                  try
		  {
    			        ps=con.prepareStatement("update Seats set SeatNo=?,ScreenClassId=?,EmpId=?, ModificationDate=? where SeatId =?");
				
				ps.setString(1,tempseatno.getText());
				ps.setString(2,tempclassid.getText());
				ps.setString(3,tempid.getText());
				ps.setString(4,tempdate.getText());
                                ps.setString(5,tempseatid.getText());
...
public void searchRecord()
{
   ...
   try
   {
	ps = con.prepareStatement("select * from Seats where "+field+"=?");
	if(field.equals("SeatNo"))
	{
	   ps.setString(1,value);
	}
	else
	if(field.equals("SeatId"))
	{
 ...
 public void valueChanged(ListSelectionEvent le)
{
		if(le.getSource() == lsm)
		{
			...
			String sno = (String)t.getValueAt(gsr,1);
			String sclassid = (String)t.getValueAt(gsr,2);
			String empid = (String)t.getValueAt(gsr,3);
			String modidate = (String)t.getValueAt(gsr,4);
                      
                        //--------------------
			tempseatid.setText(sid);
			tempseatno.setText(sno);
			tempclassid.setText(sclassid);
...
{
                tempseatid.setEditable(false);
                tempseatno.setEditable(true);
                tempclassid.setEditable(true);
...
public static void main(String args[]) 
{
    ...
    private javax.swing.JTextField tempseatid;
    private javax.swing.JTextField tempseatno;
